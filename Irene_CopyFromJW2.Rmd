...
Obtain the residuals of B15's from SEM (saved as "residuals_B15"):
```{r}
...
residuals_B15 <- data.frame(ov_pred_B15 - obs_B15)
names(residuals_B15) <- c("B15A","B15B","B15C","B15D","B15E","B15F","B15G",
                          "B15H","B15I","B15J")
```
